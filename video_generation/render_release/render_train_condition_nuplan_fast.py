...
num_classes = 16
with open(os.path.join(CURRENT_DIR, 'config_nuplan_r400.yaml'), 'r') as stream:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--occ_path', type=str, default="data/nuplan-occ/GT_occ_fast3_10hzval_r400/dense_voxels_with_semantic")
    parser.add_argument('--processed_path', type=str, default=None)
    parser.add_argument('--layout_path', type=str, default="data/nuplan_bev")
