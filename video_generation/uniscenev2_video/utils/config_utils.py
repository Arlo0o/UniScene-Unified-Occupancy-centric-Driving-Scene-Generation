...
def parse_args(training=False):
    ...
    parser.add_argument("--output", default=None, type=str, help="the dir to save model weights")
    ...
    parser.add_argument("--load", default=None, type=str, help="load")
    parser.add_argument("--sample-every", default=None, type=int, help="sample_every")
    ...
    # ======================================================
        ...
        # parser.add_argument("--start_from_scratch", default=False, type=bool, help="start training from scratch")
