...
pipeline = [
    dict(
        ...
        seg_path = "/", #"/lpai/volumes/lmm-data-proc/liuhongsi/data/occ_render_map_openscene/mini/", 
        depth_path = "/", #"/lpai/volumes/lmm-data-proc/liuhongsi/data/occ_render_map_openscene/mini/",
    ),
    dict(
...
dataset_cfg_list = [
    ((448, 800),dict(
        ...
        ann_file=[
            "./pickle/nuplan_10hz_pkl/trainval/nuplan_trainval_10hz_train_chunk_0_.pkl",  
            "./pickle/nuplan_10hz_pkl/trainval/nuplan_trainval_10hz_train_chunk_1_.pkl",  
        "./pickle/nuplan_10hz_pkl/trainval/nuplan_trainval_10hz_train_chunk_2_.pkl",   
        "./pickle/nuplan_10hz_pkl/trainval/nuplan_trainval_10hz_train_chunk_3_.pkl",  
        # "./pickle/nuplan_10hz_pkl/trainval/nuplan_trainval_10hz_train_chunk_4_.pkl",  
        # "./pickle/nuplan_10hz_pkl/trainval/nuplan_trainval_10hz_train_chunk_5_.pkl",
         ],
        pipeline=pipeline,
        dataset_root=None,
        ...
        video_length =  [ 17 ], #[1,17,"full"],#[1, 17, "full"],
...
val_dataset_cfg_list = [
    ((448, 800),dict(
        type = "NuplanVariableDataset",
        ann_file=["./pickle/nuplan_mini_10hz_pkl/nuplan_mini_val.pkl"],
        pipeline=pipeline,
        dataset_root=None,
        object_classes=object_classes,
        map_classes=map_classes,
...
# Log settings
seed = 42
outputs = "./outputs/uniscenev2_0309_pretrain_nuplan_all/0309_g06"
wandb = False
epochs = 1000
log_every = 100
ckpt_every = 500
sample_every = 500000000000000000000
load = "pretrain_ckpts/epoch1-global_step12500"
