...
pipeline = [
    dict(
        ...
        to_float32=True,
        img_path = "/lpai/dataset/openscene-lrk/0-1-0/dataset/openscene-v1.1/sensor_blobs/mini/",
        seg_path="/lpai/volumes/lmm-data-proc/liuhongsi/data/openscene_depth_vda/mini/", 
        depth_path="/lpai/volumes/lmm-data-proc/liuhongsi/data/openscene_depth_vda/mini/",
    ),
    dict(
...
dataset_cfg_list = [
    ((192, 320),dict(
        ...
        ann_file="pickle/openscene_uni_pkl/mini/openscene_mini_train.pkl",
        pipeline=pipeline,
        dataset_root=None,
        ...
        video_length =  [9, 17 ], #[1,17,"full"],#[1, 17, "full"],
        start_on_keyframe=False,
        next2topv2=True,
        trans_box2top=False,
        base_fps=12,
        fps = [ [12,], [12] ],#[[12,], [12], [12], [12]],#[[120,], [12,], [12,],],
...
# Log settings
seed = 42
outputs = "./outputs/uniscenev2_v1_control_check_0206_4_gpu_pretrain_nuplan/0219_control"
wandb = False
epochs = 1000
log_every = 10
ckpt_every = 1000
sample_every = 200
load = "./pretrain_ckpts/cam_control/epoch0-global_step8000"
