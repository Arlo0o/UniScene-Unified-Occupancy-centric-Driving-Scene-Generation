...
# Log settings
seed = 42
outputs = "./outputs/uniscenev2_v1_control_check_0224_nocondition"
wandb = False
epochs = 1000
log_every = 10
ckpt_every = 1000
sample_every = 200
load = "./outputs/uniscenev2_v1_control_check_0206_4_gpu_pretrain_nuplan/0223_occ/002-DIT3DCTRL/epoch0-global_step8000"
