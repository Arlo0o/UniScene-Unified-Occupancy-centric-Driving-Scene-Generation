...
pipeline = [
    dict(
        ...
        seg_path = "/lpai/dataset/nuplan-occ/1-1-01/nuplan-occ-render-mini/mini/", 
        depth_path = "/lpai/dataset/nuplan-occ/1-1-01/nuplan-occ-render-mini/mini/", 
...
# Log settings
seed = 42
outputs = "./outputs/uniscenev2_0325_pretrain_nuplan_all_1ref/0325_a100"
wandb = False
epochs = 1000
log_every = 100
ckpt_every = 200
sample_every = 1
load = "pretrain_ckpts/miniset_epoch4-global_step34500"
