...
dataset_cfg_list = [
    ((224, 400),dict(
        ...
        video_length = [17,33],#[1,17,"full"],#[1, 17, "full"],
        start_on_keyframe=False,
        next2topv2=True,
        trans_box2top=False,
        base_fps=12,
        fps = [[12,], [12,],],#[[120,], [12,], [12,],],
        repeat_times = [1, 1],#[1, 1, 40],
...
val_dataset_cfg_list = [
    ((224, 400),dict(
        ...
        use_valid_flag=False,
        force_all_boxes=True,
        video_length = [17,"full"],#[1,17,"full"],#[1, 17, "full"],
        start_on_keyframe=False,
        next2topv2=True,
        trans_box2top=False,
        base_fps=12,
...
model = dict(
    ...
    in_channels=vae_out_channels*2,
    ...
    raymap_embedder_downsample_rate=4.5,
)
...
outputs = "/mnt/cfs2/algorithm/zhuang.ma/code/PhiGentWorldModel/outputs/debug_outputs"
wandb = False
epochs = 1000
log_every = 1
ckpt_every = 1000
