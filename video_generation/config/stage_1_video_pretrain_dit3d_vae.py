...
outputs = "./outputs/uniscenev2_v1_control_check_0117_4_gpu_vae_sigloss"
load = "outputs/uniscenev2_v1_control_check_0117_4_gpu_vae_sigloss/003-DIT3D/epoch1-global_step84000"
nll_weights=1e-2
kl_loss_weight=1e-6
sigloss_weight = 1.0
single_lidar = True