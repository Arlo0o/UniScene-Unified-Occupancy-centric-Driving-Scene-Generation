...
pipeline = [
    dict(
        ...
        seg_path = "None", #"dataset1/nuplan-occ-render-mini/mini", 
        depth_path = "None", #"dataset1/nuplan-occ-render-mini/mini", 
...
dataset_cfg_list = [
    ...
    #     video_length =  [ 17,  33,  ], #[1,17,"full"],#[1, 17, 33, 65, "full"],
    ...
    ((448, 800),dict(
        ...
        use_valid_flag=False,
        force_all_boxes=False,
        video_length =  [  17,  ], #[1,17,"full"],#[1, 17, 33, 65, "full"],
        start_on_keyframe=False,
        next2topv2=True,
        trans_box2top=False,
        base_fps=10,
...
val_dataset_cfg_list = [
    ...
    #     use_valid_flag=False,
    #     force_all_boxes=False,
    #     video_length = [ 17,33, 65, 129 ],#[1,17,"full"],#[1, 17, "full"],
    #     start_on_keyframe=False,
    #     next2topv2=True,
    #     trans_box2top=False,
    #     base_fps=10,
...
val = dict(
    ...
    scheduler = dict(
        **scheduler,
        ...
        cfg_scale=4.5,  # base value 1, 0 is uncond
    ),
)
...
# Log settings
seed = 42
outputs = "outputs/0615_3ref_nocondition"
wandb = False
epochs = 1000
log_every = 500
ckpt_every = 500
sample_every = 500
load = "outputs/0615_3ref_nocondition/000-DIT3DCTRL/epoch0-global_step6000" # "pretrain_ckpts/miniset_epoch4-global_step34500"
