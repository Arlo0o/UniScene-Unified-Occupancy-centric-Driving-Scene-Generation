...
dataset_cfg_list = [
    ((192, 320),dict(
        ...
        ann_file="meta_data_mini_with_scene_tokens.pkl",
        pipeline=pipeline,
        dataset_root="./dataset/openscene-v1.0/sensor_blobs",
...
val_dataset_cfg_list = [
    ((192, 320),dict(
        ...
        use_valid_flag=False,
        force_all_boxes=True,
        video_length = [1,],#[1,17,"full"],#[1, 17, "full"],
        start_on_keyframe=False,
        next2topv2=True,
        trans_box2top=False,
        base_fps=12,
...
# Log settings
seed = 42
outputs = "./outputs/uniscenev2_v1_control_check_0206_4_gpu_pretrain_nuplan/0219"
wandb = False
epochs = 1000
log_every = 10
ckpt_every = 1000
