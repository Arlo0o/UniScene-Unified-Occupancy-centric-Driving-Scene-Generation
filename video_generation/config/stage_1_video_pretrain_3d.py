...
dataset_cfg_list = [
    ((224, 400),dict(
        ...
        ann_file="/mnt/cfs2/algorithm/zhuang.ma/code/clean_code/PhiGentWorldModel/data/nuscenes_mmdet3d-12Hz/nuscenes_interp_12Hz_infos_train_with_bid.pkl",
        pipeline=pipeline,
        dataset_root="/mnt/cfs2/algorithm/zhuang.ma/code/clean_code/PhiGentWorldModel/data/nuscenes/",
        ...
        video_length = [9],#[9, 17, 33, 65],#[1,17,"full"],#[1, 17, "full"],
        start_on_keyframe=False,
        next2topv2=True,
        trans_box2top=False,
        base_fps=12,
        fps = [[12,]],#[[12,], [12], [12], [12]],#[[120,], [12,], [12,],],
...
val_dataset_cfg_list = [
    ((224, 400),dict(
        type = "NuScenesVariableDataset",
        ann_file="/mnt/cfs2/algorithm/zhuang.ma/code/clean_code/PhiGentWorldModel/data/nuscenes_mmdet3d-12Hz/nuscenes_interp_12Hz_infos_val_with_bid.pkl",
        pipeline=pipeline,
        dataset_root="/mnt/cfs2/algorithm/zhuang.ma/code/clean_code/PhiGentWorldModel/data/nuscenes/",
        object_classes=object_classes,
        map_classes=map_classes,
        ...
        use_valid_flag=False,
        force_all_boxes=True,
        video_length = [9],#[1,17,"full"],#[1, 17, "full"],
        start_on_keyframe=False,
        next2topv2=True,
        trans_box2top=False,
        base_fps=12,
...
vae=dict(
    ...
    from_pretrained="/mnt/cfs2/algorithm/zhuang.ma/jck/MagicDriveDiT/data/ckpts/CogVideoX-2b",
    subfolder="vae",
    micro_frame_size=micro_frame_size,
    micro_batch_size=1,
)
...
text_encoder = dict(
    type="t5",
    from_pretrained= "/mnt/cfs2/algorithm/zhuang.ma/code/CogVideo/CogVideoX-2b-sat/t5-v1_1-xxl",
...
# Log settings
seed = 42
# outputs = "/mnt/cfs2/algorithm/zhuang.ma/code/PhiGentWorldModel/outputs/uniscenev2-v1-7v-pretrain-camera-ray-control"
outputs = "/mnt/cfs2/algorithm/zhuang.ma/code/clean_code/PhiGentWorldModel/outputs/debug_outputs_dit3d"
wandb = False
epochs = 1000
log_every = 1
ckpt_every = 1000
sample_every = 100
load = None
# load = "/mnt/cfs2/algorithm/zhuang.ma/code/PhiGentWorldModel/outputs/debug_outputs/005-DIT3D/epoch0-global_step15000"
# load = "/mnt/cfs2/algorithm/zhuang.ma/code/PhiGentWorldModel/outputs/uniscenev2-v1-7v-pretrain-camera-ray-control/006-DIT3D/epoch6-global_step23000"
# save_dir = "/mnt/cfs2/algorithm/zhuang.ma/code/PhiGentWorldModel/eval/uniscenev2_v1_control_check"
grad_clip = 1.0
# lr = 4e-5
lr = 1e-4
ema_decay = 0.99
