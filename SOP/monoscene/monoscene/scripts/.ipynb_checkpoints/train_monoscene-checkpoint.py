...
@hydra.main(config_name="monoscene_nuplan.yaml", config_path="../config")
def main(config: DictConfig):
    ...
    if config.dataset == "kitti":
        ...
        data_module = NuplanDataModule(
            root='data/nuplan_all/sensor_blobs/mini',
            pkls_path='data/nuplan_pkls',
    ...
    if os.path.isfile(model_path):
        print(f"==============================================",
                     f"Continue training from {model_path}"
              f"==============================================")
