...
train_dataset_config = dict(
    data_path='/mnt/dataset/nuplan-all/2-0-0/dataset/nuplan-v1.1',
    imageset='/mnt/volumes/ad-lmm-data-proc-bd-ga/hzhu/code/occ_gen/data/nuplan_mini_10hz_train_occ.pkl',
    occ_dataroot='/mnt/dataset/nuplan-occ/1-1-01/occ_quan/nuplan_quantized_200_200_16',
    offset=0,
    return_len=8,
