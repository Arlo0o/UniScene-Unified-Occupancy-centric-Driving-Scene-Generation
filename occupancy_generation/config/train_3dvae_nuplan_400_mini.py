...
optimizer = dict(optimizer=dict(lr=0.0001, type='AdamW', weight_decay=0.01))
...
train_dataset_config = dict(
    ...
    bev_dataroot='data/nuplan_bev_400/mini',
    offset=0,
    return_len=return_len_,
    quantize_size=(400,400,32),
    type='Nuplan_HR_occ_mini',
    debug=debug)
train_loader = dict(batch_size=1, num_workers=4, shuffle=True)
train_wrapper_config = dict(phase='train', type='tpvformer_dataset_nuplan_hr_mini_woBev')
