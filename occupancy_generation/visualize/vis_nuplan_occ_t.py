...
def draw_nusc_occupancy(
    ...
    draw(fov_voxels, voxel_size=voxel_size, vis_root=save_folder, idx=idx)
...
def draw(voxels, voxel_size=0.2, vis_root=None, idx=0):
    ...
    save_file = "outputs/3dvae_val/2025_08_14_23_08_40/save_occ/vis"
...
if __name__ == '__main__':
    folder_path = 'outputs/3dvae_val/2025_08_14_23_08_40/save_occ'  # 替换为你的文件夹路径
    ...
    for filepath in files_to_rename:
        ...
        vis_voxels = None
        for i in range(pred_voxels.shape[1]):
            vis_voxels = pred_voxels[0,i]
