...
classname_to_color = {  # RGB.
    ...
    1: (0,175,0 ), #(255, 200, 0),   # other-ground
    2: (100, 150, 245),  # vehicle
    3: (100, 230, 245),  # bicycle
    4: (255, 30, 30),  # pedestrian 
    5: (255, 240, 150),  # traffic-cone
    6: (255, 120, 50),  # barrier
    7: (255, 200, 0),  # construction-zones
    8: (196, 175, 214 ),  # generic-object
    12: (255, 0, 255), # road
...
def draw(voxels, voxel_size=0.2, vis_root=None, idx=0):
    ...
    save_file = "outputs/eval_OccDiT_outpainting_concate/2025_09_09_15_23_00/save_occ_gjzvis/"
    os.makedirs(save_file, exist_ok=True)
    filename = str(save_file) + f'/{vis_root[0]}_bev.png'
    mlab.draw()
...
if __name__ == '__main__':
    folder_path ='outputs/eval_OccDiT_outpainting_concate/2025_09_09_15_23_00/save_occ/'  # 替换为你的文件夹路径
