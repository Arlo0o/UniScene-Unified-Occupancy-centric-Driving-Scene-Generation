...
class Quantize:
    def __init__(self, 
        ...
        # pkl_file_path = "/mnt/dataset/nuplan-pkl/25-03-08-1/nuplan_pkls/nuplan_10hz_pkl/trainval/nuplan_trainval_10hz_train.pkl"
        pkl_file_path = "/mnt/dataset/nuplan-pkl/25-03-08-1/nuplan_pkls/nuplan_10hz_pkl/trainval/nuplan_trainval_10hz_train_chunk_0_.pkl"
    ...
    def process_and_save_labels(self, method):
        for label_path in tqdm(self.eval_fine_list, desc="Processing labels"):
            ...
            eval_label = load_occ_gt(label_path, grid_size=np.array((400, 400, 32)), voxel_size=np.array([200/800, 200/800, 16/64])) 
