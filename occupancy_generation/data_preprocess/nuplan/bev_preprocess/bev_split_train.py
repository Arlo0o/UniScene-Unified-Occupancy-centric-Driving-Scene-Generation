...
parser.add_argument('--input', default='data/nuplan_bev/mini/nuplan_mini_train_10hz_gt_masks_bev.h5')
parser.add_argument('--output-dir', default='data/nuplan_bev_400/mini/train')
