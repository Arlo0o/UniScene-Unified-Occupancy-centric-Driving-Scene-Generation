...
from dataset.dataload_util import CustomDataset_2frame_time,CustomDataset_2frame_continuous,CustomDataset_Tframe_continuous,Nuplan_Occ_bev_Dataset, Nuplan_Occbev_bev_Dataset
...
if __name__ == "__main__":
    ...
    parser.add_argument("--results-dir", type=str, default="outputs/nuplan_occ_dit")
