...
def main(args):
    ...
    if local_rank == 0:
        ...
        cfg.dump(osp.join(experiment_dir, osp.basename(args.config)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='config/train_3dvae_nuplan_200.py')
    parser.add_argument('--work_dir', type=str, default='./out/3dVAE_5')
