...
def main(args):
    ...
    gts_path = "/data/longhun/3D/nuplan/Nuplan-Occupancy/dataset/nuplan_occ_val/GT_occ_fast3_10hzval_r400/dense_voxels_with_semantic"
    dataset = Nuplan_Occ_bev_HR_mini(imageset,gts_path,bev_path,bev_ch_use,meta_num=4,Tframe=Tframe,training=True)
