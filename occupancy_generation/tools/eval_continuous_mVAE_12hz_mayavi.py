...
from visualize_nuscene import draw_nusc_occupancy,draw_nusc_occupancy_Bev_Front
...
def main(args):
    ...
    vis_root='/'.join(ckpt_path_list[:-2]) +f'/vis_continuous/{iter_num}_{args.cfg_scale}_{p_name_save}_mayavi/'
    zvis_root = '/'.join(ckpt_path_list[:-2]) +f'/vis_continuous/zvis/'
    ...
    occ_base_path = "/data/longhun/3D/nuscenes/data/pyramid_occ/nuscene_quantized_200_200_16/quantized"
    ...
    bev_path = "/code/code/Diff_occ/occ_gen/occ_gen/data/nuscenes/my/step2_4_200/val/bevmap_4"
    dataset = CustomDataset_Tframe_12hz(imageset,occ_base_path,bev_path,bev_ch_use,meta_num=4,Tframe=Tframe,use_clip=False,return_token=True)
        ...
        for epoch in range(start_epoch, args.epochs):
            ...
            for i_iter_val, (occ_ori,y,occ_meta, pose_meta,tokens,bev_ori) in enumerate(tqdm(loader)):
                ...
                if use_inversion:
                    ...
                    z = 0.8*torch.randn((bz,in_ch, Tframe, H,W), device=device) + 0.5*inversion_noise
                    z = torch.cat([z, z], 0)
                ...
                if vis:
                    ...
                    for i in range(Tframe):
                        ...
                        cat_image=draw_nusc_occupancy_Bev_Front(voxels=pred_i, 
                                            vox_origin=np.array([-50,-50,-5]),
                                            voxel_size=np.array([0.5,0.5,0.5]),
                                            grid=np.array([Ho,Wo,Do]),
                                            pred_lidarseg=None,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default="/data/WM/OccWorld/results/2024-08-15 14:03:10/checkpoints/0230000.pt")
    ...
    parser.add_argument("--vae_ckpt", type=str, default="out/vae_4_DwT_L_c16r2me/epoch_296.pth")
    parser.add_argument("--vae_config", type=str, default="out/vae_4_DwT_L_c16r2me/train_vae_4_DwT_L_me.py")
    ...
    parser.add_argument("--use_inversion", action='store_true', default=False) 
