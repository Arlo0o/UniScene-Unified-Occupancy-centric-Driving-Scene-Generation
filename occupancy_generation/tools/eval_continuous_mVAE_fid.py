...
from dataset.dataload_util import CustomDataset_nBEV1,CustomDataset_Tframe_continuous,CustomDataset_2frame_continuous
...
def main(args):
    ...
    # DiT_cfg={"depth":6, "in_channels":in_ch, "hidden_size":512, "use_label":False, "use_bev_concat":use_bev_concat,"bev_in_ch":1,"bev_out_ch":1,"use_meta":use_occ_meta, "meta_num":meta_num,"direct_concat":True,"Tframe":Tframe}
    # DiT_cfg={"depth":6, "in_channels":in_ch, "hidden_size":768, "use_label":False, "use_bev_concat":use_bev_concat,"bev_in_ch":1,"bev_out_ch":1,"use_meta":use_occ_meta, "meta_num":meta_num,"direct_concat":True,"Tframe":Tframe}
    # DiT_cfg={"depth":28, "in_channels":in_ch, "hidden_size":512, "use_label":False, "use_bev_concat":use_bev_concat,"bev_in_ch":1,"bev_out_ch":1,"use_meta":use_occ_meta, "meta_num":meta_num,"direct_concat":True,"Tframe":Tframe}
    # DiT_cfg={"depth":12, "in_channels":in_ch, "hidden_size":512, "use_label":False, "use_bev_concat":use_bev_concat,"bev_in_ch":1,"bev_out_ch":1,"use_meta":use_occ_meta, "meta_num":meta_num,"direct_concat":True,"Tframe":Tframe,"temp_attn":False}
    ...
    # file2_path = 'data/my_new_step2_12hz_200/val/bevmap_4'
    # gts_path = "data/nuscenes/gts"
        ...
        for epoch in range(start_epoch, args.epochs):
            ...
            for i_iter_val, (occ_ori,y,occ_meta, pose_meta) in enumerate(tqdm(loader)):
                ...
                if vis:
                    ...
                    imageio.mimsave(vis_root + f"inversion_{iter_num}_{i_iter_val}_{lambda_np}_{args.cfg_scale}.mp4",images,'mp4',fps = 4)
