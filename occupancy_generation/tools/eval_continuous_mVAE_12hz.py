...
def main(args):
    ...
    imageset = "/code/code/Diff_occ/occ_gen/occ_gen/data/nuscenes/nuscenes_mmdet3d-12Hz/nuscenes_interp_12Hz_infos_val.pkl"
    ...
    dataset = CustomDataset_Tframe_12hz(imageset,occ_base_path,bev_path,bev_ch_use,meta_num=4,Tframe=Tframe,use_clip=False)
    ...
    with torch.no_grad():
        for epoch in range(start_epoch, args.epochs):
            ...
            for i_iter_val, (occ_ori,y,occ_meta, pose_meta) in enumerate(tqdm(loader)):
                print(f"=> occ_ori shape: {occ_ori.shape}, y shape: {y.shape}")
                ...
                with torch.no_grad():
                    ...
                    print(f"z_ori.shape: {z_ori.shape}")
