...
from dataset.dataload_util import CustomDataset_wm_continuous
...
def main(args):
    ...
    dataset = CustomDataset_wm_continuous(imageset,gts_path,file1_path,bev_path,bev_ch_use,meta_num=4,Tframe=T_condition+T_pred)
