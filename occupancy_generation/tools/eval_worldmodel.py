...
from diffusion.models import DiT_2Frame, DiT_models, DiT_gjz, DiT_Occsora,DiT_WorldModel
...
def main(args):
    ...
    dataset = CustomDataset_2frame_continuous(imageset,gts_path,file1_path,file2_path,bev_ch_use,meta_num=4,Tframe=T_condition+T_pred)
        ...
        for epoch in range(start_epoch, args.epochs):
            ...
            for i_iter_val, (x_all,y_all,occ_all,occ_meta_all,pose_meta_all) in enumerate(tqdm(loader)):
                ...
                if vis:
                    ...
                    imageio.mimsave(vis_root + f"{iter_num}_{i_iter_val}_inversion-{args.cfg_scale}.mp4",images,'mp4',fps = 4)
...
if __name__ == "__main__":
    ...
    #python -m torch.distributed.launch --nnodes=1 --nproc_per_node=8 eval_continuous_mVAE_fid.py --vis --ckpt="/data/WM/OccWorld/results/2024-09-08 22:27:31/checkpoints/0080000.pt"