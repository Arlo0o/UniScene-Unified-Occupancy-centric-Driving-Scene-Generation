...
def parse_config():
    ...
    parser.add_argument('--workers', type=int, default=NUM_WORKERS, help='number of workers for dataloader')
    ...
    parser.add_argument('--selected_seq', type=int, default=None)
...
def main():
    ...
    test_set, test_loader, sampler = build_dataloader(
        ...
        dist=dist_test, workers=args.workers, logger=logger, training=False, subset_len=args.subset_len
    )
