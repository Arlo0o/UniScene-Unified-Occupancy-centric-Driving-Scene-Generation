...
from uniscenev2_lidar.models import build_network, model_fn_decorator
from uniscenev2_lidar.utils import common_utils
from train_utils.optimization import build_optimizer, build_scheduler
from train_utils.train_utils import train_model

CFG = 'tools/cfgs/nuscenes_occ_models/nuplan_sample72_r200_intenw10_pluckeremb_smoothl1_finetune_lr5e-4.yaml'
PRETRAINED = None
#PRETRAINED = 'exps/nuplan_sample72_r200_intenw10_fix_lr5e-4/ckpt/checkpoint_epoch_18.pth'
WORK_DIR = 'exps/temp'
NUM_WORKERS = 0
def parse_config():
