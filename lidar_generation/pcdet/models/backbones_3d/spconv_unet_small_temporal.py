...
from .temporal_blocks import TemporalBlock


class UNetV2SmallTemporal(UNetV2):
    """
    ...
    def __init__(self, model_cfg, input_channels, grid_size, voxel_size, point_cloud_range, **kwargs):
        ...
        temporal_block_cfg = model_cfg.get('temporal_block_cfg')
        assert temporal_block_cfg is not None
        ...
        self.conv1 = spconv.SparseSequential(
            ...
            TemporalBlock(dict(**temporal_block_cfg, input_channels=32), residual=True)
        )
        ...
        self.conv2 = spconv.SparseSequential(
            ...
            block(64, 64, 3, norm_fn=norm_fn, padding=1, indice_key='subm2'),
            TemporalBlock(dict(**temporal_block_cfg, input_channels=64), residual=True)
        )
    ...
    def forward(self, batch_dict):
        ...
        x.__setattr__('real_batch_size', batch_dict['real_batch_size'])
